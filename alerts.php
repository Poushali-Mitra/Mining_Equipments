...
$stmt->execute();//execute the query with bound values(today nd +7)
$result = $stmt->get_result();//fetching the result
/*

bind_param("ss", ...) binds two strings (s) — the start and end dates.

Executes the statement.

Retrieves the result set into $result.*/
?>
